...
public class GioHangAdapter extends BaseAdapter {
    ...
    public static class  ViewHolder{
        ...
        public static ImageView butremove;
    }
    @Override
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder==null){
            ...
            viewHolder.butremove= convertView.findViewById(R.id.butremove);
        ...
        ViewHolder.butremove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                manggiohang.remove(manggiohang.get(position));
                GioHang.EventUtil();
